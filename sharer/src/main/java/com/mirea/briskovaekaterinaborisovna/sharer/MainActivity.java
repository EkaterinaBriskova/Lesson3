package com.mirea.briskovaekaterinaborisovna.sharer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Инициализация ActivityResultLauncher, который применяется для запуска другой активности с помощью метода «launch»
